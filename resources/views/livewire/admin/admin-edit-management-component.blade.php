            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        @endif
                        <form class="form-horizontal" wire:submit.prevent="updateManagement">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="ລະຫັດຜ່ານ" class="form-control input-md" wire:model="new_password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <input type="password" placeholder="ຢືນຢັນລະຫັດຜ່ານ" class="form-control input-md" wire:model="new_password_confirmation">
