        ...
        <div class="row">
                ...
                <div class="wrap-product-detail">
                        ...
                        <div class="product-gallery" wire:ignore>
                          <ul class="slides ">
                            ...
                            <li data-thumb="{{ asset('assets/images/products') }}/{{$product->image}}">
                                <img src="{{ asset('assets/images/products') }}/{{$product->image}}" width="75%" alt="{{$product->name}}" />
                            </li>
                            @php
                    ...
                    <div class="detail-info">
                        ...
                        <div class="stock-info in-stock">
                            <p class="availability">ສະຖານະສິນຄ້າ: <b>{{$product->stock_status}}</b></p>
                        </div>
                        ...
                        <div class="wrap-butons">
							...
							@endphp
                            @if($product->sale_price > 0 && $sale->status == 1 && $sale->sale_date > Carbon\Carbon::now())
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->sale_price}})">ເພີ່ມລົງກະຕ່າ</a>
                            @else
                            <a href="#" class="btn add-to-cart" wire:click.prevent="store({{$product->id}},'{{$product->name}}',{{$product->regular_price}})">ເພີ່ມລົງກະຕ່າ</a>
                            @endif
                            <div class="wrap-btn">
                                @if($witems->contains($product->id))
											<a href="#" wire:click.prevent="removeFromWishlist({{$product->id}})" ><i class="btn btn-wishlist "> Remove Wishlist</i></a>
											@else
											<a href="#" wire:click.prevent="addToWishlist({{$product->id}},'{{$product->name}}',{{$product->regular_price}})"><i class="btn btn-wishlist"> Add Wishlist</i></a>
											@endif
                    ...
                    <div class="advance-info">
                        <div class="tab-control normal">
                            <a href="#description" class="tab-control-item active">ລາຍລະອຽດ</a>
                            <a href="#add_infomation" class="tab-control-item">ຂໍມູນເພີ່ມເຕີ່ມ</a>
             ...
             <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 sitebar">
              {{--  <div class="widget widget-our-services ">
                ...
                <div class="widget mercado-widget widget-product">
                    <h2 class="widget-title">ແນະນຳສິນຄ້າ</h2>
                    <div class="widget-content">
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    <div class="thumbnnail">
                                        <a href="{{route('product.details',['slug'=>$p_product->slug])}}" title="{{$p_product->name}}" title="{{$p_product->name}}">
            ...
            <div class="single-advance-box col-lg-12 col-md-12 col-sm-12 col-xs-12" wire:ignore>
                <div class="wrap-show-advance-info-box style-1 box-in-site">
                    <h3 class="title-box">ສິນຄ້າລ່າສຸດ</h3>
                    <div class="wrap-products">
                        <div class="products slide-carousel owl-carousel style-nav-2 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"3"},"1200":{"items":"5"}}' >
                            ...
                            <div class="product product-style-2 equal-elem " >
                                <div class="product-thumnail">
                                    <a href="{{route('product.details',['slug'=>$r_product->slug])}}" title="{{$r_product->name}}">
                                        <figure><img src="{{ asset('assets/images/products') }}/{{$r_product->image}}" class="fit-1" alt="{{$r_product->name}}"></figure>
                                    </a>
                                    <div class="group-flash">
                                        <span class="flash-item new-label">ໃໝ່</span>
                                    </div>
                                    <div class="wrap-btn">
                                ...
                                <div class="product-info">
                                    ...
                                    <div class="wrap-price"><span class="product-price">{{$r_product->regular_price}} KIP</span></div>
                                </div>
                            </div>
                            @endforeach
