<div>
    <footer id="footer">
		<div class="wrap-footer-content footer-style-1 no-print">
					...
					<div class="row">
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							<div class="wrap-footer-item">
								<h3 class="item-header">ລາຍລະອຽດການຕິດຕໍ່</h3>
						...
						<div class="col-lg-4 col-sm-4 col-md-4 col-xs-12">
							...
							{{-- <div class="wrap-footer-item">
								<h3 class="item-header">ສາຍດ່ວນ</h3>
								<div class="item-content">
			...
			<div class="coppy-right-box">
				<div class="container">
					<div class="coppy-right-item item-left">
						<p class="coppy-right-text">Copyright © 2024 FNS. All rights reserved</p>
					</div>
