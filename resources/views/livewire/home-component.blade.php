<main id="main">
    <div class="container">
        ...
        <div class="wrap-main-slide">
            <div class="slide-carousel owl-carousel style-nav-2" data-items="1" data-loop="1" data-nav="true" data-dots="false">
        ...
        <div class="wrap-show-advance-info-box style-1 has-countdown">
            ...
            <div class="wrap-products slide-carousel owl-carousel style-nav-2 equal-container " data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}'>
        ...
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box" >ສິ້ນຄ້າລ່າສຸດ</h3>
                                    ...
                                    <div class="product product-style-2 equal-elem ">
                                        <div class="product-thumnail">
                                            <a href="{{route('product.details',['slug'=>$lproduct->slug])}}" title="{{$lproduct->name}}">
                                                <figure><img src="{{asset('assets/images/products')}}/{{$lproduct->image}}" class="fit-1"  alt="{{$lproduct->name}}"></figure>
                                            </a>
                                        </div>
                                        <div class="product-info">
        ...
        <!--Product Categories-->
        <div class="wrap-show-advance-info-box style-1">
            <h3 class="title-box" >ປະເພດສິນຄ້າ</h3>
            <div class="wrap-top-banner">
                <a href="#" class="link-banner banner-effect-2">
                    <figure><img src="{{asset('assets/images/fashion-accesories-banner.jpg')}}" width="1170px" height="240px" alt=""></figure>
                </a>
            </div>
            <div class="wrap-products">
                <div class="wrap-product-tab tab-style-1">
